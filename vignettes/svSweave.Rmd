...
The 'svSweave' provides different function to better manage Sweaver and Knitr with LyX, a document processor that creates LaTeX code. These function are not detailed here. See their help page `?clean_lyx()`.
